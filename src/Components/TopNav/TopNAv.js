        ...
        <>
            <nav>
                ...
                <li onClick={() => {
                    ...
                    <li onClick={() =>{
                        handleListItemClick() 
                        setOption("Upcoming Matches") }} ><Link to="/UpcomingMatches"> <span><h5 class={option == "Upcoming Matches" ? "active" : " "} >Matches</h5></span></Link> </li>
                    ...
                    <li onClick={() => {
                        handleListItemClick()
                        setOption("list")
                    }}> <Link to="list"> <span><h5  class={option == "list" ? "active" : " "}>Country List 
                        </h5></span></Link>
                    </li>
                    <li  onClick={()=>{
                        handleListItemClick()
